...
specfem::assembly::nonconforming_interfaces_impl::interface_container<
  ...
  specfem::kokkos::HostView1d<type_real> interface_quadrature(
      "interface_quadrature", 5);
  ...
  this->edge_factor =
      EdgeFactorView("specfem::assembly::nonconforming_interfaces::edge_factor",
                     nedges, ngllx);
  // size for enabling/disabling?
  this->edge_normal = EdgeNormalView(
      "specfem::assembly::nonconforming_interfaces::edge_normal",
      (self_medium == specfem::element::medium_tag::acoustic) ? 0 : nedges,
      ngllx, 2);
  ...
  this->h_transfer_function =
      Kokkos::create_mirror_view(transfer_function);
